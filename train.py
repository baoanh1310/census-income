...
from config import BASIC_MODEL_PATH, TRAIN_DATA_PATH, TEST_DATA_PATH, DECISION_TREE_MODEL_PATH, KNN_MODEL_PATH
from utils import read_data, prepare_data, train_logreg, evaluate, train_decision_tree, train_knn
